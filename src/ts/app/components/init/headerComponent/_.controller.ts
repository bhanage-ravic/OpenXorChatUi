...
export default class headerController {
    ...
    /**
     * OpenXorChat guide displays information about the features. When a user clicks on 'OpenXorchatGuide' link, the guide is displayed.
     */
    public startXorchatGuide = () => {
    ...
    public collapse = () => {
        $("._infoComponent_c,.nav-wrapper_c").slideToggle(100, () => {
            $("._header_collapse_action_c").text(() => {
                $("._infoComponent_c").is(":visible") ? ($("._header_collapse_action_c").attr("title", "collapse openxorchat"), $("._collapse_title").text("")) : ($("._header_collapse_action_c").attr("title", "expand openxorchat"), $("._collapse_title").text("OpenXorChat"));
